...
<script type="text/javascript" src="lib/js/formulario-categoria1.js"></script>
 ...
 <div id="formulario">
  <form id="form" name="form" method="post">
   <dl>
    ...
    <dd>
     <input type="text" size="40" maxlength="200" autocomplete="off" name="txtNombre" id="txtNombre" />
     <span id="req-nombre" class="requisites error">A-z, mínimo 4 caracteres</span>
    </dd>
    <dd>
     <input type="button" class="button" value="Ingresar" name="btnConsultar" id="btnConsultar" />
